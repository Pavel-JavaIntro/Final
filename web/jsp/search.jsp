            ...
            <table
                ...
                <tr>
                    ...
                    <td
                        ...
                        <h2>Поиск книги</h2>
                        <br/>
                        <h3>Введите название книги и / или фамилии авторов и / или год издания<br/>
                        Фамилия должна быть написана без пробелов, без имени или инициалов<br/></h3>
                        <form name="searchForm" method="POST" action="library" onsubmit="return validateAuthor();">
                            ...
                            <br/>Автор:<br/>
                            <input type="text" name="author1" id="author1" value=""/>
                            <br/>Автор:<br/>
                            <input type="text" name="author2" id="author2" value=""/>
                            <br/>Год издания:<br/>
